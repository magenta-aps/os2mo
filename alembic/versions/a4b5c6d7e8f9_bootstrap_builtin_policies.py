...
# Public: every field that required no role under the legacy RBAC map (its
# `None` entries). Generated once from that map; granted to every actor.
...
def downgrade() -> None:
    ids = f"'{POLICYADMIN_UUID}', '{ADMINISTRATOR_UUID}', '{READER_UUID}', '{LEGACY_UUID}', '{OWNER_UUID}', '{PUBLIC_UUID}', '{INTROSPECTION_UUID}'"
